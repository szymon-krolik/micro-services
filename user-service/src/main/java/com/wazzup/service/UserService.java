...
import com.wazzup.client.CommonServiceClient;
...
public class UserService {
    ...
    private final CommonServiceClient COMMON_CLIENT;
    ...
    /**
     * Funkcja tworząca nowe konto użytkwonika w bazie danych
     * @param dto Dane potrzebne do zarejestrowania konta
     * @param request HttpRequest potrzebny do utworzenia ciasteczka dla użytkownika
     * @param response Odpowiedź po zarejestrowaniu
     */
    ...
    /**
     * Funkcja sprawdzająca czy email i telefon znajduje się już w bazie
     * @param email
     * @param phoneNumber
     * @return Odpowiedz czy wartosc znajduje się w bazie danych
     */
    ...
    /**
     * Encodowanie hasła do zapisania w bazie danych
    ...
    /**
     * Funckja aktywująca uzytkownika w bazie danych
     * @param token Token aktywacyjny
     * @param response HttpResponse żeby pobrac ciasteczko
     * @param request  HttpResponse żeby ustawić ciasteczko
     */
    ...
    public UserInformationWithIdDTO getUserInformationWithIdByEmail(HttpServletRequest request) {
        String token= CookieService.getTokenFromRequest(request);
        String email = JwtTokenService.getSubjectFromToken(token);
        User user = getUserByEmail(email);
       UserInformationWithIdDTO dto = USER_MAPPER.toUserInformationWithId(user);
       return dto;
    }
}
